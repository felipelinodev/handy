...
import { loginClient } from '@/features/auth/services/authService';
...
export function useLogin() {
  ...
  return {
    ...
    submit,
    goToRegister: () => router.push('/auth/register' as any),
    switchToProvider: () => router.replace('/auth/provider-login' as any),
  };
}

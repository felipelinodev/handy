...
import { ClientMaintenanceHeader } from '../components/ClientMaintenanceHeader';
import { FilterOption } from '../data/mockMaintenance';
...
import { fetchProfessionalById } from '../../services/professionalService';

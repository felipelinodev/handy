...
export const createServiceSchema = z.object({
    prestador_id: z.number({ required_error: 'O ID do prestador é obrigatório.' }),
    categoria_id: z.number({ required_error: 'O ID da categoria é obrigatório.' }),
    ...
    preco: z.number({ required_error: 'O preço é obrigatório.' }).positive('O preço deve ser um valor positivo.'),
});
